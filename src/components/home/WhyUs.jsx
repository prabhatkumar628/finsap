    ...
    return (
        <div className="w-full p-4 md:p-14 bg-white flex justify-center items-center">
            <div className="w-full h-full px-4 py-6  md:p-6 lg:px-12 md:pb-12 flex-1 border-2 border-[#8ea8d0]">
                <p className="text-3xl sm:text-4xl md:text-5xl xl:text-7xl tracking-wider text-[#043e96] pb-4 md:pb-8 mb-4 md:mb-10 text-center relative after:absolute after:content-[''] after:w-[80px] after:h-[2px] after:bottom-0 after:left-[50%] after:translate-x-[-50%] after:bg-[#0ed4ff]">
                    Why Us?
                </p>
