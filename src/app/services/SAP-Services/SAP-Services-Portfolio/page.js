...
export default function SapServicesPortfolio() {
  return (
    <>
      <div className='w-full min-h-screen bg-white relative px-4 py-16 sm:py-20  md:px-6 lg:px-12'>
        ...
        <div style={{ clipPath: "polygon(0 0, 90% 0, 100% 100%, 0 100%)" }} className='min-h-8 sm:min-h-12 w-[40%] sm:w-[45%] md:w-64 bg-[#0dd4ff] absolute bottom-0 left-0'></div>

        <div className="w-full h-full px-4 py-6  md:p-6 lg:px-12 md:pb-12 flex-1 border-2 border-[#8ea8d0]">
          <div className={unbounded.className}>
            <h1 className="text-3xl md:text-4xl xl:text-5xl py-2 font-light text-[#043e96] relative after:absolute after:content-[''] after:w-[80px] after:h-[2px] after:bottom-0 after:left-0 after:bg-[#0ed4ff]">
          ...
          <div className={`${unbounded.className}  gap-6 lg:gap-12 mt-4`}>
            <div className=' flex flex-col gap-4 md:gap-10'>
              ...
              <p className='text-[#043e96] text-xl sm:tracking-wider font-light'>
